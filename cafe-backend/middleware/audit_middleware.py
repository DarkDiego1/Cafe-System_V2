...
# Mapeo tipo_evento → accion válida para el CHECK constraint de la BD
ACCION_MAP = {
    "crear_ingrediente":    "INSERT",
    "modificar_ingrediente":"UPDATE",
    "eliminar_ingrediente": "DELETE",
    "ajuste_stock_manual":  "UPDATE",
    "entrada_mercancia":    "UPDATE",
    "registrar_merma":      "INSERT",
    "crear_proveedor":      "INSERT",
    "modificar_proveedor":  "UPDATE",
    "crear_empleado":       "INSERT",
    "modificar_empleado":   "UPDATE",
    "cambiar_rol":          "UPDATE",
    "modificar_menu":       "UPDATE",
    "configurar_umbrales":  "UPDATE",
    "generar_reporte":      "INSERT",
    "crear_orden_compra":   "INSERT",
    "cambiar_estado_orden": "UPDATE",
    "login":                "LOGIN",
    "logout":               "LOGOUT",
}
